...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    image2 = Image.open("etc/Dexter.png")
...
async def playlist(client, message):
    ...
    msg = "**Now Playing** in {} 🤟.⚫Pᴏᴡᴇʀᴇᴅ Bʏ ∂єϰτєя мυѕιϲ ".format(message.chat.title)
    msg += "\n- "+ now_playing
    msg += "\n- Req by "+by
    temp.pop(0)
    if temp:
...
async def play(_, message: Message):
                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @GODS_ASSISTANT to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="▶️ **Playing** here the song requested by {} via  ∂єϰτєя мυѕιϲ 🥀".format(
...
async def deezer(client: Client, message_: Message):
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"✧DerteR_MuSic✧= #️⃣ Queued at position {position}")
    else:
        await res.edit_text("✧DexteR_MuSic=▶️ Playing.....")
...
async def jiosaavn(client: Client, message_: Message):
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✧DexteR_MuSic✧=#️⃣ Queued at position {position}",
